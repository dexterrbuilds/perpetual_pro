...
DEFAULT_WATCHLIST = (
    "BTC,ETH,SOL,BNB,AAVE,ADA,AERO,ALGO,ARB,ATOM,AXS,BCH,BERA,BGB,BRETT,CAKE,"
    "BSV,CHZ,CRO,DASH,DOT,FIL,GRASS,HBAR,ICP,INJ,JUP,XLM,XMR,XTZ,ZEC,TIA,S,"
    "SEI,RAY,OP,NEAR,MNT,KAS,KAIA"
)
